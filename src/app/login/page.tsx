...
export default function LoginPage() {
	...
	return (
		<Section sectionClass="login-container h-[calc(100vh-175px)] bg-gradient-hero flex items-center justify-center p-6">
			<div className="flex items-center bg-gradient-card justify-center my-12 rounded-lg border text-card-foreground shadow-sm">
				<div className="flex flex-col w-full max-w-xs gap-4">
					<div className="flex flex-col text-center p-6 gap-2">
						...
						<p className="text-sm text-muted-foreground tracking-tight">Sign in to your account to continue managing your tasks</p>
					</div>
